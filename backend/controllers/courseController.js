...
const createCourse = async (req, res) => {
    const {title,subject, previewLink, subtitle, price, promotion, promotionDuration, summary,finalExam, instructor,individualTrainee,courseRating,numberOfRates,reviews,instructorRate,numOfRates,accumlatedRates,accRates,enrolledStudents} = req.body;
    ...
    const Course = await course.create({title,subject, previewLink, subtitle, price, promotion, promotionDuration, summary,finalExam, instructor,individualTrainee,courseRating,numberOfRates,reviews,instructorRate,numOfRates,accumlatedRates,accRates,enrolledStudents});
