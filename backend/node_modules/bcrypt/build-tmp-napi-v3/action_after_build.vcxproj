...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{AF8213B6-9B93-16E0-84C7-21F1EE163D40}</ProjectGuid>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\bcrypt_lib.node">
      ...
      <Command>call mkdir &quot;D:\BlueHats\backend\node_modules\bcrypt\lib\binding\napi-v3&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)bcrypt_lib.node&quot; &quot;D:\BlueHats\backend\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/bcrypt_lib.node to D:\BlueHats\backend\node_modules\bcrypt\lib\binding\napi-v3</Message>
      <Outputs>D:\BlueHats\backend\node_modules\bcrypt\lib\binding\napi-v3\bcrypt_lib.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="bcrypt_lib.vcxproj">
      <Project>{BF9486CE-6BCD-BD53-8387-1B4C645014EF}</Project>
